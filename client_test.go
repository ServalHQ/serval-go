...
func TestUserAgentHeader(t *testing.T) {
	...
	client.AccessPolicies.Get(context.Background(), "id")
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.AccessPolicies.Get(context.Background(), "id")
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.AccessPolicies.Get(cancelCtx, "id")
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.AccessPolicies.Get(deadlineCtx, "id")
		if err == nil {
