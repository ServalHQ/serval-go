...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.AccessPolicies.List(context.Background(), serval.AccessPolicyListParams{})
	if userAgent != fmt.Sprintf("Serval/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.AccessPolicies.List(context.Background(), serval.AccessPolicyListParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.AccessPolicies.List(cancelCtx, serval.AccessPolicyListParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.AccessPolicies.List(deadlineCtx, serval.AccessPolicyListParams{})
		if err == nil {
