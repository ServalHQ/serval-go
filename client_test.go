...
func TestUserAgentHeader(t *testing.T) {
	...
	client.AccessPolicies.New(context.Background(), serval.AccessPolicyNewParams{})
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.AccessPolicies.New(context.Background(), serval.AccessPolicyNewParams{})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.AccessPolicies.New(cancelCtx, serval.AccessPolicyNewParams{})
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.AccessPolicies.New(deadlineCtx, serval.AccessPolicyNewParams{})
		if err == nil {
