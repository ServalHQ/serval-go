...
func (r *TeamService) Get(ctx context.Context, id string, opts ...option.RequestOption) (res *TeamGetResponse, err error) {
...
func (r *TeamService) Update(ctx context.Context, id string, body TeamUpdateParams, opts ...option.RequestOption) (res *TeamUpdateResponse, err error) {
...
func (r TeamNewResponse) RawJSON() string { return r.JSON.raw }
func (r *TeamNewResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type TeamGetResponse struct {
	Team  TeamGetResponseTeam `json:"team"`
...
// Returns the unmodified JSON received from the API
func (r TeamGetResponse) RawJSON() string { return r.JSON.raw }
func (r *TeamGetResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type TeamGetResponseTeam struct {
	ID string `json:"id"`
	// A Timestamp represents a point in time independent of any time zone or local
	// calendar, encoded as a count of seconds and fractions of seconds at nanosecond
	// resolution. The count is relative to an epoch at UTC midnight on January 1,
...
// Returns the unmodified JSON received from the API
func (r TeamGetResponseTeam) RawJSON() string { return r.JSON.raw }
func (r *TeamGetResponseTeam) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
// Returns the unmodified JSON received from the API
func (r TeamUpdateResponse) RawJSON() string { return r.JSON.raw }
func (r *TeamUpdateResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type TeamListResponse struct {
	Data       []TeamListResponseData `json:"data"`
...
// Returns the unmodified JSON received from the API
func (r TeamListResponseData) RawJSON() string { return r.JSON.raw }
func (r *TeamListResponseData) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
type TeamNewResponseEnvelope struct {
	Data TeamNewResponse `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
...
type TeamGetResponseEnvelope struct {
	Data TeamGetResponse `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
...
type TeamUpdateResponseEnvelope struct {
	Data TeamUpdateResponse `json:"data"`
	// JSON contains metadata for fields, check presence with [respjson.Field.Valid].
	JSON struct {
		Data        respjson.Field
		ExtraFields map[string]respjson.Field
